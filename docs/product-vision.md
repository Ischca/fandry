...
| 決済プロバイダ | Segpay | Stripe | Stripe | 独自 |
...
- 投げ銭: 50件 × 500円 = 25,000円
- 合計売上: 135,000円
- プラットフォーム手数料: 約12,000円
- 純収益: 約123,000円
```
...
**現在の構成:**
- ホスティング: Railway（アダルト対応）
- ストレージ: Cloudflare R2（アダルト対応）
- 決済: Segpay（アダルト専門）
- 認証: Clerk
